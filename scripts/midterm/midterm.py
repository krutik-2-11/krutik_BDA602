...
def process_dataframes(dataset, df, predictors, response):
    ...
    # save_dataframe_to_HTML(df_mor_categorical, PLOT_LINK_MOR, caption=CATEGORICAL_PREDICTORS_CAPTION)
    # save_dataframe_to_HTML(df_mor_continuous, PLOT_LINK_MOR, caption=CONTINUOUS_PREDICTORS_CAPTION)
    # save_dataframe_to_HTML(df_resp_vs_pred_categorical, PLOT_LINK, caption=CATEGORICAL_PREDICTORS_CAPTION)
    # save_dataframe_to_HTML(df_resp_vs_pred_continuous, PLOT_LINK, caption=CONTINUOUS_PREDICTORS_CAPTION)
